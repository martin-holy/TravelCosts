...
const appStores = {
  ...
  ADM_AppStoreGroups: new AppStore({
  ...
  GLO_CountriesStay: new AppStore({
  ...
  CAR_Refueling: new AppStore({
    name: 'CAR_Refueling', id: 31, title: 'Refueling', orderBy: 'kmTotal', orderAsc: false, onSaveFunc: 'carCalcConsumptions',
    properties: [
      { name: 'id', title: 'Id', type: 'int', required: true, hidden: true },
      { name: 'date', title: 'Date', type: 'date', required: true, align: 'center' },
      { name: 'kmTotal', title: 'Total', type: 'int', required: true, align: 'right' },
  ...
  CAR_PresencePerDay: new AppStore({
